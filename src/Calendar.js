...
>>>>>>> 21a9f15e862dcd66ce9688ac50910cd74e3c4ed0
                ...
                <Box flex-direction="row" display="inline-flex" columnGap={"10px"} paddingRight={"10px"} boxSizing={"border-box"} maxHeight={"2.5em"}>
                    ...
                    <Button onClick={nextYear} 
                            sx={{ color: "black", border: "2px #A1A1A1 solid", 
                            borderRadius: "10px", backgroundColor: "white", paddingLeft: "20px" }}>
                            <Typography sx={{ textTransform: "capitalize", fontFamily: "Merriweather", fontSize: "20px"}}>
                                next year
                            </Typography>
                            <ArrowForwardIosTwoToneIcon fontSize="small" sx={{ marginLeft: "10px", color: "#A1A1A1", }}></ArrowForwardIosTwoToneIcon>
                            <ArrowForwardIosTwoToneIcon fontSize="small" sx={{ marginLeft: "-10px", color: "#A1A1A1" }}></ArrowForwardIosTwoToneIcon>
